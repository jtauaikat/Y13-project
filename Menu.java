...
public class Menu implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        switch(menuName){
            ...
            case "help":
                ...
                break;
            case "restart":
                if(!freezeRestart){ //if not frozen, allows restart
                    mainLoop.restartGameInMenu(storeButtonSize,storeGridSize, storeMineCount); //resets game
                }
                break;
            case "quit":
    ...
    public void setTimerToggle(boolean currentState){
        freezeRestart = currentState; //prevents user from duplicating window
    }
}
